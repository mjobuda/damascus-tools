...
var __all__ = dict ({get __name__ () {return __name__;}, set __name__ (value) {__name__ = value;}, get getReport () {return getReport;}, set getReport (value) {getReport = value;}});
var __name__ = 'div_issues.issue387.test1';
export var getReport = function () {
	return 'From test1: {}'.format (div_issues.issue387.test1.test2.C.__module__);
};

//# sourceMappingURL=div_issues.issue387.test1.map