...
export {asin, phase, isfinite, tan, isinf, asinh, cos, log, tanh, pi, exp, atanh, sin, e, acos, sqrt, cosh, sinh, atan, log10, isnan, rect, polar, acosh};
...
export var run = function (autoTester) {
	...
	(function () {
		var __accu0__ = autoTester;
		return __call__ (__accu0__.check, __accu0__, __call__ (round, null, __getitem__ (aPolar, 0), nDecs), __getitem__ (aPolar, 1));
	}) ();
