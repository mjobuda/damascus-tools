...
export {accumulate, compress, islice, count, chain, pow, combinations, takewhile, starmap, combinations_with_replacement, dropwhile, filterfalse, permutations, cycle, repeat, tee, product, groupby};
