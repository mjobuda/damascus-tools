...
var __all__ = dict ({get C () {return C;}, set C (value) {C = value;}, get __name__ () {return __name__;}, set __name__ (value) {__name__ = value;}, get c () {return c;}, set c (value) {c = value;}});
...
//# sourceMappingURL=div_issues.issue387.test1.test2.map