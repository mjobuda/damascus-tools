// Transcrypt'ed from Python, 2021-05-31 11:17:05
var itertools = {};
var math = {};
var random = {};
...
export var yValuesList = [(function () {
	var __accu0__ = [];
...
try {
	...
	Plotly.plot (kind, [dict ({x: xValues, y: yValues})], dict ({title: kind, xaxis: dict ({title: 'x'}), yaxis: dict ({type: 'log', tickformat: '2e', title: 'exp (x**2)'})}));
}
catch (__except0__) {
	// pass;
}
export var tangentialValues = list (range (-(180), 180));
export var radialValuesList = [(function () {
	var __accu0__ = [];
...
var kind = 'surface';
Plotly.plot (kind, [dict ({x: denseGrid, y: denseGrid, z: getZValues (denseGrid, denseGrid), type: kind, zmin: -(0.2), zmax: 1})], dict ({title: kind}));
export var labels = ['much', 'more', 'most'];
var kind = 'bar';
Plotly.plot (kind, [dict ({name: 'rare', x: labels, y: [1, 2, 4], type: kind}), dict ({name: 'common', x: labels, y: [8, 16, 32], type: kind})], dict ({title: kind, barmode: 'group'}));
var kind = 'pie';
Plotly.plot (kind, [dict ({values: [1, 2, 3, 4, 5, 6], labels: ['least', 'less', 'little', 'much', 'more', 'most'], type: kind})], dict ({title: kind}));
var kind = 'scatter3d';
