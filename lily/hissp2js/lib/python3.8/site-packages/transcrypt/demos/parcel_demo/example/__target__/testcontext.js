// Transcrypt'ed from Python, 2021-05-16 22:52:43
var random = {};
...
import {ONE_HUNDRED} from './constants.js';
...
export var Test =  __class__ ('Test', [object], {
	...
	get __exit__ () {return __get__ (this, function (self, exc_type, exc_value, exc_tb) {
		if (exc_value) {
			console.warn ('Fail: {}  { exception raised }'.format (self.title));
			return null;
		}
		var expected_value = self.random_num + ONE_HUNDRED;
...
//# sourceMappingURL=testcontext.map