// Transcrypt'ed from Python, 2021-05-31 10:54:00
...
export var render = function (user) {
	return dom.div ('.users', [dom.button ('.get-random', 'Get random user'), (!(user) ? null : dom.div ('.user-details', [dom.h1 ('.user-name', user.py_name), dom.h4 ('.user-email', user.email), dom.a ('.user-website', dict ({'attrs': dict ({'href': user.website})}), user.website)]))]);
};
