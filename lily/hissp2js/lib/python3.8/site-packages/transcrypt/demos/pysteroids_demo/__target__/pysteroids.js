// Transcrypt'ed from Python, 2021-05-31 11:17:26
var audio = {};
var logging = {};
var math = {};
var random = {};
...
import {FPSCounter, clamp, coroutine, now, set_limits, wrap} from './utils.js';
import {Asteroid, Bullet, Ship} from './units.js';
import {ControlAxis, Keyboard} from './controls.js';
...
export var Audio =  __class__ ('Audio', [object], {
	...
	get __init__ () {return __get__ (this, function (self, audio_path) {
		...
		self.fire_rota = [audio.clip (pth ('344276__nsstudios__laser3.wav')), audio.clip (pth ('344276__nsstudios__laser3.wav')), audio.clip (pth ('344276__nsstudios__laser3.wav')), audio.clip (pth ('344276__nsstudios__laser3.wav'))];
		self.explosion_rota = [audio.clip (pth ('108641__juskiddink__nearby-explosion-with-debris.wav')), audio.clip (pth ('108641__juskiddink__nearby-explosion-with-debris.wav')), audio.clip (pth ('108641__juskiddink__nearby-explosion-with-debris.wav')), audio.clip (pth ('108641__juskiddink__nearby-explosion-with-debris.wav'))];
...
export var Game =  __class__ ('Game', [object], {
	...
	get create_controls () {return __get__ (this, function (self) {
		...
		var suppress_scroll = function (e) {
			if (__in__ (e.keyCode, [32, 37, 38, 39, 40])) {
				e.preventDefault ();
			}
		};
