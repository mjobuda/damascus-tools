// Transcrypt'ed from Python, 2021-05-31 10:54:53
...
var __name__ = 'compound_variables';
export var a = [1, 2, 3];
var a = [11.0, 12, 13.0];
var a = tuple ([4, 5, 6]);
var a = new set ([4, 5, 6]);
var a = [7, 8, 9, 10, 11];
export var b = [1.0, 2, 3];
var b = [1, 2.0, 3.0];
var b = [1.0, 2.0, 'three'];
export var c = [1.1, 2.2, 3.3];
var c = [1, 2, 3];
var c = [4, 5.5, 6];
export var d = tuple ([1, 2]);
var d = tuple ([3, 4, 5]);
var e = [];
var e = [1, 2.5];
var e = [3, 4, 5];
...
//# sourceMappingURL=compound_variables.map