// Transcrypt'ed from Python, 2021-05-31 10:54:26
...
export var py_name = input ('Hi, what is your name? ');
print ('Hello', py_name, 'I am your computer.');
export var age = float (input ('How old are you? '));
if (age < 12) {
...
//# sourceMappingURL=if_else_prompt.map